                        ...
                        <div className="container">
                            <div className="slider-1-height-3 slider-animated-1">
                                ...
                                <div className="slider-img">
                                    <img src="/assets/imgs/slider/slider-4.png" alt="Snappy Fresh promotional banner" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="single-hero-slider single-animation-wrap">
                        <div className="container">
                            <div className="slider-1-height-3 slider-animated-1">
                                ...
                                <div className="slider-img">
                                    <img src="/assets/imgs/slider/slider-5.png" alt="Snappy Fresh promotional banner" />
                                </div>
                            </div>
                        </div>
                    </div>
